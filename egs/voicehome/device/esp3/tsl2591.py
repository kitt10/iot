...
class Tsl2591:
    def __init__(self, scl_pin_nb=5, sda_pin_nb=4, sensor_id='tsl2591', integration=INTEGRATIONTIME_100MS, gain=GAIN_LOW):
        self.sensor_id = sensor_id
        self.bus = SMBusEmulator(scl_pinno=scl_pin_nb, sda_pinno=sda_pin_nb)
