...
\crefname{appendix}{Příloha}{Příloha}
...
%\usepackage[raggedright]{titlesec} %removes hyphenation from titles and substitles

%removes first blank page (first white page in document)
