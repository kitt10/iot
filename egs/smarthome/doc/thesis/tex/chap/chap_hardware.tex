...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9 \textwidth]{nodemcu_tsl2591.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6 \textwidth]{bme280.png}
